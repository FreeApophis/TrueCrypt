...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	KeyfilesMenu = new wxMenu();
	wxMenuItem* ChangeKeyfilesMenuItem;
	ChangeKeyfilesMenuItem = new wxMenuItem( KeyfilesMenu, wxID_ANY, wxString( _("Add/Remove Keyfiles to/from Volume...") ) , wxEmptyString, wxITEM_NORMAL );
	KeyfilesMenu->Append( ChangeKeyfilesMenuItem );
	
	wxMenuItem* RemoveKeyfilesMenuItem;
	RemoveKeyfilesMenuItem = new wxMenuItem( KeyfilesMenu, wxID_ANY, wxString( _("Remove All Keyfiles from Volume...") ) , wxEmptyString, wxITEM_NORMAL );
	KeyfilesMenu->Append( RemoveKeyfilesMenuItem );
	
	KeyfilesMenu->AppendSeparator();
	
	wxMenuItem* SetDefaultKeyfilesMenuItem;
	SetDefaultKeyfilesMenuItem = new wxMenuItem( KeyfilesMenu, wxID_ANY, wxString( _("Set Default Keyfiles/Paths...") ) , wxEmptyString, wxITEM_NORMAL );
	KeyfilesMenu->Append( SetDefaultKeyfilesMenuItem );
	
	MainMenuBar->Append( KeyfilesMenu, _("&Keyfiles") );
	
	FavoritesMenu = new wxMenu();
	AddToFavoritesMenuItem = new wxMenuItem( FavoritesMenu, wxID_ANY, wxString( _("Add Selected Volume...") ) , wxEmptyString, wxITEM_NORMAL );
	FavoritesMenu->Append( AddToFavoritesMenuItem );
	
	AddAllMountedToFavoritesMenuItem = new wxMenuItem( FavoritesMenu, wxID_ANY, wxString( _("Add All Mounted Volumes...") ) , wxEmptyString, wxITEM_NORMAL );
	...
	MountAllFavoritesMenuItem = new wxMenuItem( FavoritesMenu, wxID_ANY, wxString( _("Mount All Favorite Volumes") ) , wxEmptyString, wxITEM_NORMAL );
	...
	MainMenuBar->Append( SettingsMenu, _("Setti&ngs") );
	...
	this->Connect( SetDefaultKeyfilesMenuItem->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( MainFrameBase::OnDefaultKeyfilesMenuItemSelected ) );
...
KeyfilesDialogBase::KeyfilesDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	KeyfilesHyperlink = new wxHyperlinkCtrl( this, wxID_ANY, _("What is a keyfile?"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
...
InfoWizardPageBase::InfoWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	...
	bSizer72->Add( InfoStaticText, 1, wxALL|wxEXPAND, 5 );
...
KeyfilesPanelBase::KeyfilesPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	gSizer3->Add( AddFilesButton, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	AddDirectoryButton = new wxButton( this, wxID_ANY, _("Add &Directory..."), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer3->Add( AddDirectoryButton, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	RemoveButton = new wxButton( this, wxID_ANY, _("&Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer3->Add( RemoveButton, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	RemoveAllButton = new wxButton( this, wxID_ANY, _("Remove &All"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer3->Add( RemoveAllButton, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxLEFT, 5 );
	
	bSizer21->Add( gSizer3, 0, wxEXPAND|wxRIGHT, 5 );
...
VolumeCreationIntroWizardPageBase::VolumeCreationIntroWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	wxBoxSizer* bSizer84;
	...
	bSizer85->Add( 0, 0, 0, wxEXPAND|wxTOP, 5 );
	
	StandardVolumeRadioButton = new wxRadioButton( this, wxID_ANY, _("Create a standard TrueCrypt volume"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer85->Add( StandardVolumeRadioButton, 0, wxALL, 5 );
	
	HiddenVolumeRadioButton = new wxRadioButton( this, wxID_ANY, _("Create a hi&dden TrueCrypt volume "), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer85->Add( HiddenVolumeRadioButton, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	
	bSizer85->Add( 0, 0, 0, wxEXPAND|wxTOP|wxBOTTOM, 5 );
	
	HiddenVolumeHyperlink = new wxHyperlinkCtrl( this, wxID_ANY, _("What is a hidden volume?"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
	
	HiddenVolumeHyperlink->SetHoverColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOWTEXT ) );
	HiddenVolumeHyperlink->SetNormalColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOWTEXT ) );
	HiddenVolumeHyperlink->SetVisitedColour( wxSystemSettings::GetColour( wxSYS_COLOUR_WINDOWTEXT ) );
	bSizer85->Add( HiddenVolumeHyperlink, 0, wxALL, 5 );
	...
	InfoStaticText = new wxStaticText( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	InfoStaticText->Wrap( -1 );
	bSizer85->Add( InfoStaticText, 0, wxALL, 5 );
	
	
	bSizer85->Add( 0, 0, 0, wxTOP|wxBOTTOM|wxEXPAND, 5 );
	
	bSizer84->Add( bSizer85, 1, wxEXPAND, 5 );
	...
	// Connect Events
	HiddenVolumeHyperlink->Connect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( VolumeCreationIntroWizardPageBase::OnHiddenVolumeHyperlinkClick ), NULL, this );
}

VolumeCreationIntroWizardPageBase::~VolumeCreationIntroWizardPageBase()
{
	// Disconnect Events
	HiddenVolumeHyperlink->Disconnect( wxEVT_COMMAND_HYPERLINK, wxHyperlinkEventHandler( VolumeCreationIntroWizardPageBase::OnHiddenVolumeHyperlinkClick ), NULL, this );
}
...
VolumeLocationWizardPageBase::VolumeLocationWizardPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : WizardPage( parent, id, pos, size, style )
{
	...
	bSizer87->Add( 0, 0, 0, wxEXPAND|wxTOP|wxBOTTOM, 5 );
	...
	bSizer89->Add( VolumePathComboBox, 0, wxALL|wxEXPAND, 5 );
	...
	bSizer90->Add( SelectFileButton, 0, wxEXPAND|wxTOP|wxRIGHT|wxLEFT, 5 );
	
	SelectDeviceButton = new wxButton( this, wxID_ANY, _("Select D&evice..."), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer90->Add( SelectDeviceButton, 0, wxALL, 5 );
...
VolumePasswordPanelBase::VolumePasswordPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	KeyfilesButton->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( VolumePasswordPanelBase::OnKeyfilesButtonRightClick ), NULL, this );
	KeyfilesButton->Connect( wxEVT_MIDDLE_UP, wxMouseEventHandler( VolumePasswordPanelBase::OnKeyfilesButtonRightClick ), NULL, this );
...
VolumePasswordPanelBase::~VolumePasswordPanelBase()
{
	...
	KeyfilesButton->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( VolumePasswordPanelBase::OnKeyfilesButtonRightClick ), NULL, this );
	KeyfilesButton->Disconnect( wxEVT_MIDDLE_UP, wxMouseEventHandler( VolumePasswordPanelBase::OnKeyfilesButtonRightClick ), NULL, this );
