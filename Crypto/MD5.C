 ...
 */
void _cdecl MD5Init ( MD5_CTX *mdContext)
{
 ...
 */
void _cdecl MD5Update (register MD5_CTX *mdContext, unsigned char *inBuf,
		 unsigned int inLen)
{
  register int i, ii;
  int mdi;
 ...
 */
void _cdecl MD5Final (unsigned char digest[16], MD5_CTX *mdContext)
{
  UINT4 in[16];
  int mdi;
  unsigned int i, ii;
